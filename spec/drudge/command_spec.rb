...
class Drudge
  ...
  describe Command do
    ...
    describe "a command with a couple of parameters" do 
      subject do
        Command.new(:greet,
                    [ Param.new(:greeter, :string),
                      Param.new(:greeted, :string)],
    ...
    describe "Argument parsers" do
      describe "a command called 'greet' with one parameter" do
        subject(:command) do
          Command.new(:greet, [Param.new(:greeted, :string)], -> { puts "Hello" })
        end
      ...
      describe "a comand called 'greet' with one parameter and two keyword parameters" do
        subject(:command) do
          Command.new(:greet, 
                      [Param.new(:message, :string), 
                       KeywordParam.new(:from, :string), 
                       KeywordParam.new(:to, :string),
                       KeywordParam.new(:coming_from, :string)],
